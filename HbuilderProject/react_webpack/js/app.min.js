...
/***/ function(module, exports, __webpack_require__) {
	...
	var React=__webpack_require__(1);
	var ReactDOM = __webpack_require__(38);
	var ComponentDetail=__webpack_require__(175)
	...
	var ComponentList=React.createClass({displayName: "ComponentList",
		...
		render:function(){
			...
			for(var i=0;i<child.length;i++){//遍历 1.每条数据传递给子组件  2.循环叠加子组件个数
				//console.log(_state[i]);
				_temp.push(React.createElement(ComponentListItem, {name: child[i]}));
			}
			return(
		...
		clickHandle:function(event){
			...
			$.ajax({
				...
				success:function(data){
					...
					ReactDOM.unmountComponentAtNode(document.getElementById('list'));
					//装载新组件
					ReactDOM.render(React.createElement(ComponentDetail, null),document.getElementById("list"))
				}
			})
			...
			return(
				React.createElement("div", {style: _css.listitem}, 
							React.createElement("div", {style: _css.listimg}, 
								React.createElement("img", {onClick: this.clickHandle, title: this.props.name.goodsID, style: _css.img, src: this.props.name.goodsListImg})
							), 
