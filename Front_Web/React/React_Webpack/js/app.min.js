...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentList=__webpack_require__(170);
	var ComponentFooter=__webpack_require__(173);
	/**声明这个页面的布局容器  开始**/
			...
			$.ajax({
				...
				success:function(data){
				   ...
				   //3.显示数据{
					...
					ReactDOM.render(React.createElement(ComponentList, {name: data}),document.getElementById("list"));
				...
				React.createElement("div", null, 
				   React.createElement("section", {style: _style.search}, 
					React.createElement("div", {style: _style.searchbox}, 
					   ...
					   React.createElement("input", {onChange: this.changeHandle, style: _style.searchinput, type: "text", placeholder: "请输入搜索内容"})
					)
				)
				)
			);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React=__webpack_require__(1);
	var ReactDOM=__webpack_require__(38);
	var ComponentDetail=__webpack_require__(171);
	var ComponentList=React.createClass({displayName: "ComponentList",
		...
		render:function(){
			...
			for(var i=0;i<child.length;i++){//遍历 1.每条数据传递给子组件  2.循环叠加子组件个数
				_temp.push(React.createElement(ComponentListItem, {key: i, name: child[i]}));
			}
			return(
		...
		clickHandle:function(event){
			...
			$.ajax({
				...
				success:function(data){
					...
					//ComponentDetail
					ReactDOM.render(React.createElement(ComponentDetail, null),document.getElementById("banner"));
				}
			});
			...
			return(
				React.createElement("div", {style: _css.listitem}, 
							React.createElement("div", {style: _css.listimg}, 
								React.createElement("img", {onClick: this.clickHandle, title: this.props.name.goodsID, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React=__webpack_require__(1);
	var ComponentDetail =React.createClass({displayName: "ComponentDetail",
		render:function(){
			var styles=this.CSS;
			return(
				React.createElement("div", null, 
				   ...
				   React.createElement("div", {style: styles.footer}, 
				       React.createElement("div", {style: styles.footerIcon}, "介绍"), 
				       React.createElement("div", {style: styles.footerIcon}, "详情"), 
				       React.createElement("div", {style: styles.footerIcon}, "实拍")
				   )
				)
			);
		}
	...
	var ComponentBanner=React.createClass({displayName: "ComponentBanner",
		...
		render:function(){
			...
			for(var i=0;i<_state.length;i++){
				temp.push(React.createElement(ComponentBannerItem, {key: i, name: _state[i]}));
			}
			return(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React=__webpack_require__(1);
	var ReactDOM=__webpack_require__(38);
	var NewComponent=__webpack_require__(174);

	var ComponentBanner=__webpack_require__(172);
	var ComponentList=__webpack_require__(170);

	var ComponentShopcar=__webpack_require__(175);
